...
def test_magic_link_email_wordmark_links_to_the_homepage(client, account):
    # MagicLinkRequestView.extra_email_context is a property, resolved per-request
    # against SiteConfig -- read it off an instance, not the class, and assert
    # against whatever SITE_BASE_URL the process resolved to.
